...
class Recognition {
  ...
  /*+
      location.left.toInt().toString() +
      "," +
      location.width.toInt().toString() +
      "," +
      CameraViewSingleton.inputImageSize.width.toInt().toString() +
      ' ' +
      position;*/
  ...
  String get position {
    double center = 6 * location.left + 3 * location.width;
    double imageWidth = CameraViewSingleton.inputImageSize.height;
